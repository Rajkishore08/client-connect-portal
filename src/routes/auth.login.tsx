        ...
        <div className="surface-card p-6 sm:p-8 rounded-3xl border border-border/80 bg-card shadow-lg">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">
              Sign in to view your application history &amp; session notifications.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#forgot" onClick={() => alert("Password reset link sent!")} className="text-[11px] font-semibold text-primary hover:underline">
                    Forgot?
                  </a>
                </div>
                <div className="relative">
