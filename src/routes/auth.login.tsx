...
function LoginPage() {
  ...
  const { login, loginWithGoogle, loginAsGuest, user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-50 grid lg:grid-cols-2">
        ...
        <div className="relative z-10 space-y-8 my-8">
          <div className="space-y-3 max-w-xl">
            <h1 className="text-3xl lg:text-4xl font-extrabold tracking-tight font-display leading-tight text-slate-900">
              Simplify Travel, <br />
              <span className="text-blue-600">Build Digital SaaS,</span> <br />
      ...
      {/* Right Column: Complete Light Theme Sign In Card */}
        ...
        <div className="my-auto py-8 max-w-md w-full mx-auto space-y-6">
          <div className="space-y-2 text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-500 font-medium">
              Sign in to access your client dashboard and track active intakes.
            </p>
          </div>

          {/* Main Light Theme Sign In Form */}
          <div className="surface-card p-6 sm:p-7 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-5">
            ...
            {/* 2. MIDDLE: Email & Password Form */}
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                <Label htmlFor="login-email" className="font-bold text-xs text-slate-700">
                  Email Address *
                </Label>
                <div className="relative">
              ...
              <div className="space-y-1">
                <Label htmlFor="login-pass" className="font-bold text-xs text-slate-700">
                  Password *
                </Label>
                <div className="relative">
