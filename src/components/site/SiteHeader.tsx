          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="rounded-full px-3 py-1.5 text-xs font-semibold text-slate-700 transition-colors hover:bg-slate-100 whitespace-nowrap flex items-center gap-1 cursor-pointer">
                  <Cpu className="h-3.5 w-3.5 text-blue-600" /> AI Platforms <ChevronDown className="h-3 w-3 text-slate-400" />
                </button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="start" className="w-56 p-2 bg-white z-[9999]">
                <DropdownMenuItem asChild>
                  <Link to="/agentic-ai-platform" preload="intent" className="cursor-pointer text-xs py-2 font-semibold flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-indigo-600" /> Agentic AI Platform
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to="/whatsapp-automation-tool" preload="intent" className="cursor-pointer text-xs py-2 font-semibold flex items-center gap-2">
                    <MessageSquare className="h-4 w-4 text-emerald-600" /> WhatsApp Automation Engine
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
                      ...
                      <AccordionItem value="services-mobile" className="border-none">
                        ...
                        <AccordionContent className="pl-4 space-y-1 pt-1 pb-2">
                          ...
                          <Link
                            ...
                            onClick={() => setOpen(false)}
                            className="block rounded-lg px-3 py-2 text-xs font-semibold text-indigo-700 hover:bg-slate-100"
                          >
                            Agentic AI Platform
                          </Link>
                          <Link
                            ...
                            onClick={() => setOpen(false)}
                            className="block rounded-lg px-3 py-2 text-xs font-semibold text-emerald-700 hover:bg-slate-100"
                          >
